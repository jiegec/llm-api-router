...
> **Note**: This project is designed to be simple and easy to deploy for basic use cases. For more complex requirements, consider using [litellm](https://github.com/BerriAI/litellm)/[axonhub](https://github.com/looplj/axonhub) or other advanced LLM routing solutions.
